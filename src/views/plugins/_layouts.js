...
const layoutLg = [
  {i: '0', x: 0, y: 0, w: 1, h: 17, static: true, cardClass: 'card-accent-primary', cardHeader: 'Static'},
...
const layoutMd = [
  {i: '0', x: 0, y: 0, w: 1, h: 24, static: true, cardClass: 'card-accent-primary', cardHeader: 'Static'},
...
const layoutSm = [
  {i: '0', x: 0, y: 0, w: 1, h: 1, static: true, cardClass: 'card-accent-primary', cardHeader: 'Static'},
